...
const demoScript = [
  ...
  },
  {
    ...
    href: "/demo/judge",
    action: "Start judge demo",
  },
  {
    step: "01:20",
    title: "Run the operator console",
    copy: "Open the console, edit the BAT-4421 evidence, recompute traceability, and show the coverage gap becoming a review gate.",
    href: "/console",
    action: "Open console",
  },
  {
